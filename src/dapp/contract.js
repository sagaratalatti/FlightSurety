...
export default class Contract {
    ...
    getInsuranceCost(callback) {
        this.FlightSuretyApp.methods.INSURANCE_COST().call(callback);
    }

    getFundingValue(callback) {
        this.FlightSuretyApp.methods.AIRLINE_FUNDING_VALUE().call(callback);
    }

    isFunded(callback) {
        this.FlightSuretyData.methods.isAirlineFunded(this.owner).call(callback);
    }
